    ...
    <div class="container">
        ...
        <form action="<?php echo base_url('pelayanan/store'); ?>" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="pelayanan_name" class="form-control" placeholder="nama warga">
            </div>
            <div class="form-group">
                <label for="">NIK</label>
                <input type="text" name="pelayanan_code" class="form-control" placeholder="nik">
            </div>
            <div class="form-group">
                <label for="">ALAMAT</label>
                <textarea name="pelayanan_description" class="form-control" placeholder="alamat"></textarea>
            </div>
            <div class="form-group">
