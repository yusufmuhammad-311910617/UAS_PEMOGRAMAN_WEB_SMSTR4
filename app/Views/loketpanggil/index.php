                        ...
                        <td>
                            <div class="btn-group">
                                <?php if (is_numeric($aa)) {
                                    echo "<a href='" . base_url('loketpanggil/edit/' . $aa) . "' class='btn btn-success'>Konfirmasi</a>";
                                } else {
                        ...
                        <td>
                            <div class="btn-group">
                                <?php if (is_numeric($bb)) {
                                    echo "<a href='" . base_url('loketpanggil/edit/' . $bb) . "' class='btn btn-success'>Konfirmasi</a>";
                                } else {
                                    echo "<a class='btn btn-danger'>Kosong<a>";
                                }  ?>
                            </div>
                        ...
                        <td>
                            <div class="btn-group">
                                <?php if (is_numeric($cc)) {
                                    echo "<a href='" . base_url('loketpanggil/edit/' . $cc) . "' class='btn btn-success'>Konfirmasi</a>";
                                } else {
                                    echo "<a class='btn btn-danger'>Kosong<a>";
                                }  ?>
                            </div>
                        ...
                        <td>
                            <div class="btn-group">
                                <?php if (is_numeric($dd)) {
                                    echo "<a href='" . base_url('loketpanggil/edit/' . $dd) . "' class='btn btn-success'>komifrmasi</a>";
                                } else {
                                    echo "<a class='btn btn-danger'>Kosong<a>";
                                }  ?>
                            </div>
